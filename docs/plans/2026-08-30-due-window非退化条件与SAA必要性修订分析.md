...
2026-08-31 已将本文及前序讨论收束为统一的 Work 3 问题设定报告：[随机 due-window 多机调度的问题设定、非退化机制与文献依据](2026-08-31-work3随机due-window多机调度问题设定与文献依据.md)。本文继续保留逐项推导和历史边界，后续建模以该统一报告的 W3-Core 为准。
